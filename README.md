...
**CapitalScope** turns this into a learning environment where AI agents can master treasury operations through trial, reward, and iteration.

---

## What Makes This Different

Most finance AI demos are just sentiment classifiers or stock price predictors. CapitalScope models an actual *operational workflow* with real constraints:

| Real Treasury Problem | How CapitalScope Models It |
|---|---|
